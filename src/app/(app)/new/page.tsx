  ...
  return (
    <div className="mx-auto max-w-2xl">
      <PageHeader
        ...
        description="Upload your resume and we'll pull out the claims worth defending in an interview."
      />
      ...
      <div
        ...
        onDrop={onDrop}
        className={cn(
          'grid cursor-pointer place-items-center rounded-2xl border border-dashed px-6 py-14 text-center transition-colors',
      ...
      <Button onClick={onSubmit} loading={submitting} className="mt-6 w-full sm:w-auto">
